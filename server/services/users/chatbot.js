  ...
  models.sequelize.query(query).then(result => {
    if (result[0].length === 2) {
      ...
      const query_next = `SELECT * FROM restaurants WHERE closedown=0 AND
       ...
       ${food_type_flag} (match(food_type) against('${food_type}' in boolean mode))
       ORDER BY RAND() LIMIT 2;`
      console.log("@@@ Query_next: ", query_next);
...
function verifySearchFood (req, res) {
    ...
    models.sequelize.query(`SELECT * FROM restaurants WHERE closedown=0 AND subway = '${subway}' AND food_name LIKE '%${search_food}%' ORDER BY rand() limit 2;`).then(result => {
        if (result[0].length == 2){
...
function verifyMood2 (req, res) {
    ...
    //         if (result[0].length === 2){
    //           // filtered_list.push(filter[0]).then(function (filtered_list){
    ...
    //         if (result[0].length === 2){
    //           // filtered_list.push(filter[1]).then(function (filtered_list){
    //             // resolve(filtered_list)
    //           // })
    //           filtered_list.push(filter[1]);
    //           resolve(filtered_list);
    //           // resolve(filtered_list.push(filter[1]).this);
    //         } else {
    //           resolve(filtered_list);
    //         }
    //     }).catch(function (err){
    ...
    //         if (result[0].length === 2){
    //           // filtered_list.push(filter[2]).then(function (filtered_list){
    //             // resolve(filtered_list)
    //           // })
    ...
    //         if (result[0].length === 2){
    //           // filtered_list.push(filter[3]).then(function (filtered_list){
    //             // resolve(filtered_list)
    //           // })
    ...
    //         if (result[0].length === 2){
    //           // filtered_list.push(filter[4]).then(function (filtered_list){
    //             // resolve(filtered_list)
    //           // })
